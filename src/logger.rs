...
/// # 参数
/// - logger_level: 日志等级
pub async fn init_logger(logger_level: &str) -> anyhow::Result<WorkerGuard> {
    ...
    // 按照当前日期生成日志文件名 medicine_sys.log.2026-04-12
    let file_appender = rolling::daily(log_dir, "medicine_sys.log");
